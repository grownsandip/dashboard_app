...
const FormModal = ({ table, type, data, id }: { table: "faculty" | "student" | "subject" | "semester" | "exam" | "assignment" | "event" | "announcement" | "parent" |"class" |"lesson"|"result"; type: "create" | "update" | "delete"; data?: any; id?: number | string }) => {
