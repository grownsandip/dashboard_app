      ...
      <div className="min-h-screen flex fle-col items-center justify-center lg:p-6 p-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p className="text-sm mt-6 text-white">Don't have an account? <Link href="/sign-up" className="text-white font-semibold underline ml-1">Register here</Link></p>
          </div>
          <div className="bg-white rounded-xl sm:px-6 px-4 py-8 max-w-md w-full h-max shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] max-lg:mx-auto">
            <form>
              ...
              <div className="mt-8">
                <button type="button" className="w-full shadow-xl py-3 px-6 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none" onClick={() =>
              ...
              <p className="text-sm mt-8 text-center text-gray-800">Don't have an account? <Link href="/sign-up" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</Link></p>
            </form>
          </div>
        </div>
      </div>
