      ...
      <div className='w-full xl:w-1/3 flex flex-col gap-4'>
        <div className='bg-white p-4 rounded-md'>
          ...
          <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
            <Link href={`/classes?/instructorId=${"teacher2"}`} className='rounded-md p-3 bg-Sky'>Teacher&apos;s Classes</Link>
            <Link href={`/students?/facultyId=${"teacher2"}`} className='rounded-md p-3 bg-pink-50'>Teacher&apos;s Students</Link>
            <Link href={`/lessons?/facultyId=${"teacher2"}`} className='rounded-md p-3 bg-Purple'>Teacher&apos;s Lessons</Link>
            <Link href={`/exams?/facultyId=${"teacher2"}`} className='rounded-md p-3 bg-YellowLight'>Teacher&apos;s Exams</Link>
            <Link href={`/assignments?/facultyId=${"teacher2"}`} className='rounded-md p-3 bg-lightSky'>Teacher&apos;s Assignments</Link>
          </div>
        </div>
        <Performance/>
        <Announcements/>
